...
CONFIG["ppo"]["trainer_config"]["muscle_num_epochs"] = 3
...
CONFIG["ppo_medium"]["trainer_config"]["muscle_sgd_minibatch_size"] = 512
# CONFIG["ppo_medium"]["trainer_config"]["marginal_sgd_minibatch_size"] = 512
CONFIG["ppo_medium"]["trainer_config"]["discriminator_sgd_minibatch_size"] = 512
CONFIG["ppo_medium"]["trainer_config"]["discriminator_batch_size"] = 8192  #  CONFIG["ppo_medium"]["train_batch_size"]
...
CONFIG["ppo_small"]["trainer_config"][
    "discriminator_batch_size"
] = 4096  #  CONFIG["ppo_medium"]["train_batch_size"]
...
CONFIG["ppo_mini"]["trainer_config"]["discriminator_batch_size"] = CONFIG["ppo_mini"][
    "train_batch_size"
]
CONFIG["ppo_mini"]["trainer_config"]["world_sgd_minibatch_size"] = CONFIG["ppo_mini"][
    "train_batch_size"
]
